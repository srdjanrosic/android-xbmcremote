...
import org.xbmc.android.remote.lib.presentation.controller.SettingsController;
...
public class SettingsActivity extends PreferenceActivity {
	...
	protected Class<SettingsController>mSettingsControllerClass = SettingsController.class;
	...
	protected void instantiateSettingsController() {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		IEventClientManager client = EventClientManager.getInstance(mSettingsController, getApplicationContext());	
		try {
			switch (keyCode) {
